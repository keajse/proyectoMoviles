...
const RegisterScreen = () => {
  ...
  return <View style={Styles.container}>
    ...
    <View style={Styles.inputDataContainer}>
      ...
      <TextInput style={Styles.inputDataUser} placeholder="Email" inlineImageLeft='outline_contact_mail_black_18' inlineImagePadding={20} keyboardType="email-address"></TextInput>
      <TextInput style={Styles.inputDataUser} placeholder="Phone Number" inlineImageLeft='outline_support_agent_black_18' inlineImagePadding={20} keyboardType="numeric"></TextInput>
      <TextInput style={Styles.inputDataUser} placeholder="Password" inlineImageLeft='outline_vpn_key_black_18' inlineImagePadding={20} secureTextEntry={true}></TextInput>
